    ...
    <div class="min-h-screen py-5 mb-8">
        <div class="max-w-xl lg:mx-auto sm:mx-auto mx-4">
            <div class="bg-white rounded-lg shadow-lg min-h-fit">
                <div class="flex items-center justify-between mb-0 bg-base-300">
                    <div class="p-3">
                    ...
                    <div class="p-3">
                        <h1 class="font-bold">E-Receipt</h1>
                    </div>
                </div>

                <div class="flex justify-center p-3 items-center">
                    <h1 class="font-medium text-2xl">{{ $transaction->type === 1 ? '+' : '-' }} {{ number_format($transaction->amount) }} <sup class="font-light">(Ks)</sup></h1>
                </div>

                <div class="p-3">
                    <div class="flex justify-between items-center mb-3">
                        <h1 class="font-thin  text-gray-500">Transaction Time</h1>
                        <h1 class="font-medium text-base">{{ $transaction->created_at }}</h1>
                    </div>
                    <div class="flex justify-between items-center mb-3">
                        <h1 class="font-thin   text-gray-500">Transaction No.</h1>
                        <h1 class="font-medium text-base">{{ $transaction->transcation_id }}</h1>
                    </div>
                    <div class="flex justify-between items-center mb-3">
                        <h1 class="font-thin   text-gray-500">Transaction Ref No.</h1>
                        <h1 class="font-medium text-base">{{ $transaction->ref_no }}</h1>
                    </div>
                    <div class="flex justify-between items-center mb-3">
                        <h1 class="font-thin   text-gray-500">Transaction Type</h1>
                        <h1 class="font-medium text-base">{{ $transaction->type === 1 ? 'Income' : 'Expense' }}</h1>
                    </div>
                    <div class="flex justify-between items-center mb-3">
                    ...
                    <div class="flex justify-between items-center mb-3">
                        <h1 class="font-thin   text-gray-500">Ammount</h1>
                        <h1 class="font-medium text-base">{{ $transaction->type === 1 ? '+' : '-' }} {{ number_format($transaction->amount) }} Ks</h1>
                    </div>
                    <div class="flex justify-between items-center mb-3">
                        <h1 class="font-thin   text-gray-500">Notes</h1>
                        <h1 class="font-medium text-base">{{ $transaction->note }}</h1>
                    </div>
                </div>
                <div >
